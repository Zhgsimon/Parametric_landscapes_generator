...
m_tige{{m_coords.getX(), m_coords.getY()-15}, {m_coords.getX()+util::alea(1, 3, rg), m_coords.getY()+util::alea(0, 2, rg)}, {m_coords.getX()-util::alea(1, 3, rg), m_coords.getY()+util::alea(0, 2, rg)}, {245, 245, 220}}
{}
