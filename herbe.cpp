...
m_herbe1{{m_coords}, {m_coords.getX()+3, m_coords.getY()-5}, {m_coords.getX()+6, m_coords.getY()}, {util::alea(74, 124, rg), util::alea(102, 252, rg), util::alea(0, 24, rg)}},
m_herbe2{{m_coords.getX()-10, m_coords.getY()+5}, {m_coords.getX()-5, m_coords.getY()+5}, {m_coords.getX()-3, m_coords.getY()-5}, {util::alea(74, 124, rg), util::alea(102, 252, rg), util::alea(0, 24, rg)}},
m_herbe3{{m_coords.getX()+10, m_coords.getY()+5}, {m_coords.getX()+18, m_coords.getY()+5}, {m_coords.getX()+16, m_coords.getY()}, {util::alea(74, 124, rg), util::alea(102, 252, rg), util::alea(0, 24, rg)}}
{}//124, 252, 0 //85, 107, 47
