...
void Ciel::VarColFonc(Heure& heure)
{
    ...
    if(heure.getHeure()>=7&&heure.getHeure()<12)
        m_ciel.setCouleur({254-224*(heure.getHeure()-7)/(5) ,155-11*(heure.getHeure()-7)/(5), 70+185*(heure.getHeure()-7)/(5)});
    ...
    if(heure.getHeure()>=17&&heure.getHeure()<20)
        m_ciel.setCouleur({40+214*(heure.getHeure()-17)/(3) , 190-35*(heure.getHeure()-17)/(3), 255-185*(heure.getHeure()-17)/(3)});

        ///De 20h a 23h     00h etant le milieu de la nuit
    if(heure.getHeure()>=20&&heure.getHeure()<=23)
        m_ciel.setCouleur({254-202*(heure.getHeure()-20)/4 , 155-93*(heure.getHeure()-20)/4, 70+163*(heure.getHeure()-20)/4});
        ///De 00h a 7h
    if(heure.getHeure()>=0&&heure.getHeure()<7)
        m_ciel.setCouleur({52+202*(heure.getHeure()-0)/5 , 62+93*(heure.getHeure()-0)/5, 233-163*(heure.getHeure()-0)/5});
}
