...
m_petales1{{m_coords.getX()-m_centre_fleur.getRayon(),m_coords.getY()-30},m_centre_fleur.getRayon()-1,{255,174,201}},
m_petales2{{m_coords.getX(),m_coords.getY()+m_centre_fleur.getRayon()-30},m_centre_fleur.getRayon()-1,{255,174,201}},
m_petales3{{m_coords.getX()+m_centre_fleur.getRayon(),m_coords.getY()-30},m_centre_fleur.getRayon()-1,{255,174,201}},
m_petales4{{m_coords.getX(),m_coords.getY()-m_centre_fleur.getRayon()-30},m_centre_fleur.getRayon()-1,{255,174,201} }
{}
