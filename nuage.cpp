...
m_nuage2{{m_coords.getX()+m_nuage1.getRayonX(),m_coords.getY()}, m_nuage1.getRayonX()*util::alea(0.6,0.9,rg), m_nuage1.getRayonY()*util::alea(0.6,0.9,rg), {255, 255, 255}},
m_nuage3{{m_coords.getX()-m_nuage1.getRayonX(),m_coords.getY()}, m_nuage1.getRayonX()*util::alea(0.3,0.6,rg), m_nuage1.getRayonY()*util::alea(0.3,0.6,rg),{250, 250, 250}}
{}
...
void Nuage::dessiner(Svgfile& svgout)
{
    ...
    for (int i=1; i<25; ++i)
        degrade.push_back(new Ellipse{{m_coords}, m_nuage1.getRayonX()-(i/2), m_nuage1.getRayonY()-(i/2), {255-i, 255-i, 255-i}});
